...
if __name__ == "__main__":
    # Mon/Wed/Fri schedule. EC2 starts at 05:50, stops at 07:00 UTC.
    ...
    process_deploy = process_and_embed.to_deployment(
        ...
        cron="30 6 * * 1,3,5",  # After ingestion completes (~20 min)
    )
    drift_deploy = drift_check.to_deployment(
        name="drift-check",
        cron="50 6 * * 1,3,5",  # After process-and-embed finishes (~10 min)
    )
